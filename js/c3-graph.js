...
(function() {
  ...
  c3.Sankey = (function(_super) {
    ...
    Sankey.prototype._layout = function(origin, current_data, current_links, current_nodes) {
      var alpha, collision_detection, column, columns, delta, i, iteration, j, key, layout_links, link, node, node_link, node_links, r, source_link_value, source_node, target_link_value, target_node, tmp, total_source_link_value, total_weighted_y, v_domain, weighted_y, y, _base, _i, _j, _k, _l, _len, _len1, _len10, _len11, _len12, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _len9, _m, _n, _o, _p, _q, _r, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _s, _t, _u, _v;
      ...
      if (this.node_label_options != null) {
        ...
        if ((_ref7 = this.node_labels_clip) != null) {
          _ref7.all.remove();
        }
    ...
    Sankey.prototype._style = function(style_new) {
      ...
      if ((_ref = this.node_labels) != null) {
        _ref.options(this.node_label_options);
      }
      ...
      if ((_ref1 = this.node_labels) != null) {
